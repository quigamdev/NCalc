...
namespace NCalc.Tests
{
    public class Fixtures
    {
        ...
        public void ShouldEvaluateOperators()
        {
            ...
            {
                Assert.Equal(pair.Value, new Expression(pair.Key).Evaluate()); //pair.Key + " failed"
            }
        ...
        public void ShouldReuseCompiledExpressionsInMultiThreadedMode()
        {
            ...
            for (int cpt = 0; cpt < 20; cpt++)
            {
                ...
                if (_exceptions.Count > 0)
                {
                    ...
                    Assert.False(true);// (_exceptions[0].Message);
                }
            }
        }
        ...
        public void ShouldHandleCaseSensitiveness()
        {
            ...
            Assert.False(true);// ("Should throw ArgumentException");
        }
